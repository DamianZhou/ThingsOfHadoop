...
// Note that this example is very similar to the PoolingDriver example.
...
//  * 参数1：the connect string for your underlying JDBC driver
//  * 参数2:the query you'd like to execute
...
public class BasicDataSourceExample {
	...
	public static DataSource setupDataSource(String connectURI) {
		...
		ds.setDriverClassName("com.cloudera.impala.jdbc4.Driver"); //impala
		ds.setUrl(connectURI); //jdbc:impala://192.168.129.63:21050/stock
		return ds;
	}

	/**
	 * 打印DataSource状态：活动/空闲 的 connection
	 * @param ds
	 */
